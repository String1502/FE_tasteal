    ...
    return (
        <CustomCard {...props}>
            ...
            <Radio
                ...
                checkedIcon={<DoneRounded sx={{ color: 'black', fontSize: '12px' }} />} // DoneRounded when checked
                checked={checked}
                onClick={handleClick}
                {...saveCheckBoxProps}
                sx={{
                    ...
                    right: padding * 8,
                    zIndex: 1,
                    backgroundColor: checked ? 'rgba(255, 255, 255, 0.8)' : '(255, 255, 255, 0.2)',
                    color: 'white',
