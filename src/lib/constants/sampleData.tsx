...
import { PersonalCartItem } from '../models/entities/PersonalCartItem/PersonalCartItem';
...
export const accounts: AccountEntity[] = [
    ...
    },
    {
        ...
        avatar: defaultAvtPath,
        introduction:
            'Chúc mọi người một ngày tốt lành! Tôi là Người Dùng Năm.',
    },
    {
        uid: '6',
        name: 'Người Dùng Sáu',
...
export const ingredients: IngredientEntity[] = [
    {
        id: 1,
        name: 'Bơ',
        image: 'https://www.sidechef.com/ingredient/small/434769be-6df9-493e-8b3b-31264065311f.jpg?d=96x96',
        type_id: 1,
        nutrition_info_id: 1,
        isLiquid: true,
        ratio: 0.5,
...
export const personalCartItems: PersonalCartItem[] = [
    {
        id: 1,
        ingredient_id: 1,
        account_id: '1',
